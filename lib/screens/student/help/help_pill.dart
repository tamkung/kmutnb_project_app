...
class HelpPill extends StatefulWidget {
  const HelpPill({Key? key}) : super(key: key);
...
class _HelpPillState extends State<HelpPill> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'คุณต้องการขอความช่วยเหลือยารักษา',
                  style: TextStyle(
  ...
  Widget _btn(name, color) {
    ...
    return ElevatedButton(
      ...
      onPressed: () async {
        if (name == "ยืนยัน") {
          AllFunction().postRequest(user.displayName, 'ต้องการยารักษา');
          await createData('ต้องการยารักษา');
          print(name);
        } else {
